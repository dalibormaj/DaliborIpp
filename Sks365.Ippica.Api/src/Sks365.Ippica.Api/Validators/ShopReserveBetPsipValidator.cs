...
{
    public class ShopReserveBetPsipValidator : AbstractValidator<ShopReserveBetRequest<PsipBetDto>>
    {
        public ShopReserveBetPsipValidator(ICustomAuthorization customAuthorization, ISessionTracker sessionTracker, IUserService userService)
        {
