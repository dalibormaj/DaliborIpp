...
{
    public class WebReserveBetPsipValidator : AbstractValidator<WebReserveBetRequest<PsipBetDto>>
    {
        public WebReserveBetPsipValidator(ICustomAuthorization customAuthorization, ISessionTracker sessionTracker, IUserService userService)
        {
