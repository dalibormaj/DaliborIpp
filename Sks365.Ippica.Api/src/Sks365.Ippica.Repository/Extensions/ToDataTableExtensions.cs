...
namespace Sks365Ippica.Repository.Extensions
{
    public static class ToDataTableExtensions
    {
        ...
        public static DataTable ToDataTable<T>(this List<T> list, string dataTableName = null) where T : BaseDomainModel
        {
            ...
            if (itemType.IsValueType) throw new InternalServerErrorException(ReturnCodeEnum.Unknown, "Cannot convert to DataTable");
